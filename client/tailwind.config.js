...
export default {
  ...
  theme: {
  	extend: {
  		...
  		backgroundImage: {
  			'gradient-custom': 'linear-gradient(150deg, rgba(242,200,237,1) 0%, rgba(169,223,216,1) 100%)',
  			'gradient-primary': 'linear-gradient(150deg, rgba(11,46,51,1) 0%, rgba(79,124,130,1) 100%)',
  			'gradient-secondary': 'linear-gradient(150deg, rgba(242,240,239,1) 0%, rgba(255,255,255,1) 100%)',
  		...
  		boxShadow: {
  			...
  			'inset-custom': 'inset -22px -14px 14px 2px hsla(0, 0%, 100%, .015), inset 8px 4px 20px 12px rgba(0, 0, 0, .8)',
  			...
  			'inset-white-2': 'inset -2px -2px 4px hsla(0, 0%, 100%, .1), inset 2px 2px 4px rgba(0, 0, 0, .5)'
  		},
  		borderRadius: {
  			lg: 'var(--radius)',
