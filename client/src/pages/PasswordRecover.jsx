...
import { resetPassword, checkResetLink, clearErrors } from "../redux/features/password/resetPasswordSlice";
...
export const PasswordRecover = () => {
    ...
    }, [status, errors, message, dispatch, navigate]);
                ...
                <form 
                    ...
                    <div>
                        <button
                            type="submit"
                            disabled={loading}
                            className="flex w-full justify-center rounded-3xl bg-accent mt-10 px-3 py-1.5 text-sm font-semibold text-gray-100 shadow-sm hover:bg-accentDark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent active:scale-90 transition-all"
                        >
