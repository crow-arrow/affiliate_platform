          ...
          >
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  readOnly
                  autoComplete="email"
                  className="block w-full rounded-3xl shadow-inset-2 outline-none focus:outline-none active:outline-none bg-primaryLite dark:bg-primary px-3 py-1.5 text-base text-gray-900 dark:text-gray-100 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-accent sm:text-sm"
                />
              </div>
            </div>
            <div>
            ...
            <div className='md:col-span-2 flex justify-end'>
              <button
                ...
                disabled={loading}
                className="
                  w-full md:w-1/4 rounded-xl bg-gradient-blurLite dark:bg-gradient-blur dark:hover:bg-gradient-blur text-gray-800 dark:text-gray-300 
                  mt-6 px-4 py-1.5 text-lg font-semibold text-center hover:text-accentGreen dark:hover:text-accentAqua
