...
export const updateLevelSettings = createAsyncThunk(
  ...
  async (data: { levelSettings: LevelSetting[]; appSettings: AppSettings }, { rejectWithValue }) => {
    try {
...
export const { addLevel, updateLevel, removeLevel, updateAppSettings, clearError } = adminSettingsSlice.actions;
