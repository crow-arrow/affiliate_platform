...
export const AdminLayout = () => {
    ...
    return (
        ...
        {/* Background */}
        <div 
            className="absolute inset-0 bg-primaryLite dark:bg-primary before:absolute before:inset-0 transition-colors duration-500"></div>

        {/* Content */}
        <div className="relative z-10 flex h-full text-gray-800 dark:text-gray-200">
            {/* Sticky Navbar */}
            <aside className={`sticky top-0 self-start mr-8 mb-4 box-border text-gray-500 transition-[width] duration-300 ${isOpen ? 'w-64' : 'w-12'}`}>
