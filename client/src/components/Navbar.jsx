  ...
  return (
    ...
    {isAuth && <div className="fixed left-0 top-0 flex flex-col flex-grow-1 w-60 px-8 pb-4 border-r-2 min-h-screen">
      <div className="logo px-2 py-8">
        <Link to="/" aria-hidden="true" role="img" className="iconify iconify--logos">
            ...
            <ul className="flex flex-col gap-y-2">
              ...
              <li className='flex'>
                <NavLink to="../pages/trips" 
                  className={({ isActive }) => `group flex p-2 gap-2 w-full text-s rounded-md hover:bg-slate-100 hover:text-accent ${isActive && 'bg-slate-100 text-accent'}`}>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2.5V4.5" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round"/>
                    <path d="M12 9.5V11.5" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round"/>
                    <path d="M12 16.5V21.5" stroke="currentColor" strokeWidth="1.5" stroke-linecap="round"/>
