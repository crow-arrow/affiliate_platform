...
function FieldLegend({
  ...
  return (
    <legend
      ...
      className={cn(applyTypography(variant === "legend" ? "body" : "label"), "mb-3", className)}
      {...props}
    />
  );
}
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        applyTypography("body-sm", "text-muted-foreground"),
        "leading-normal group-has-[[data-orientation=horizontal]]/field:text-balance",
  ...
  return (
    ...
    >
      ...
      {children && (
        <span
          className={cn(
            applyTypography("caption", "bg-background text-muted-foreground"),
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(applyTypography("body-sm", "text-destructive"), className)}
      {...props}
    >
      {content}
    </div>
