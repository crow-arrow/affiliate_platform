        ...
        <div>
            {isAuth && <div className="fixed right-0 top-0 inline-flex w-full pl-60 h-20 justify-between bg-white">
                ...
                <label className="relative block w-full">
                    ...
                    <input className="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-accent focus:ring-accent focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search"/>
                </label>
                <div className="flex items-center justify-between gap-x-4">
                    ...
                    <button 
                        ...
                        className="
                            ...
                            hover:bg-accentDark hover:text-white transition-colors"
                        >
                        Logout
                    </button>
                </div>
