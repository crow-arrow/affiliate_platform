            ...
            {isAuth && <div className="inline-flex w-full h-20 justify-between">
                <header className="flex w-full justify-between items-center px-8">
                    ...
                    <label className="relative block mx-8 w-full">
                        ...
                        <input className="placeholder:italic placeholder:text-slate-400 block bg-white opacity-80 w-full border border-slate-300 rounded-md py-2 pl-4 pr-3 shadow-sm focus:outline-none focus:border-accent focus:ring-accent focus:ring-1 sm:text-sm" placeholder="Search for anything..." type="text" name="search"/>
                    </label>
                    <div className="flex items-center justify-between gap-x-4">
                        ...
                        <div className="relative w-40">
                            ...
                            {dropdownOpen && (
                                <div className="absolute z-100 -bottom-4 mt-2 w-40 text-gray-200 shadow-lg"
                                    onMouseEnter={handleMouseEnter} 
                                    onMouseLeave={handleMouseLeave}
                                >
                                    <button
