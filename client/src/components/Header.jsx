        ...
        <div>
            {isAuth && <div className="inline-flex w-full h-20 justify-between">
                <header className="flex w-full justify-between items-center px-8">
                    <div className="logo w-1/5 mr-8">
                        <Link to="/admin/dashboard" aria-hidden="true" role="img" className="iconify iconify--logos">
                    ...
                    <div className='flex flex-1 justify-between items-center'>
                        <label className="relative block mr-8 w-full">
                            ...
                            <div className="relative w-40">
                                ...
                                >
                                    ...
                                    <div className="text-start">
                                        ...
                                        <span className="text-xm block text-stone-500">
                                            {userRole}
                                        </span>
                                    </div>
                                ...
                                {dropdownOpen && (
                                    <div>
                                        <ul className="absolute w-auto whitespace-nowrap z-10 right-0 top-20 rounded-3xl shadow-custom-white text-gray-200 bg-[linear-gradient(rgba(255,255,255,0.3),transparent)] backdrop-blur-sm"
                                            ...
                                            onMouseLeave={handleMouseLeave}
                                        >
                                            <li className="w-full px-4 py-2 rounded-3xl text-gray-200 hover:text-accent hover:outline hover:outline-1 hover:-outline-offset-1 hover:outline-gray-100 transition-all">
                                                <Link
                                                    to="../settings"
                                            ...
                                            <li className="w-full px-4 py-2 rounded-3xl box-border text-gray-200 hover:text-accent hover:outline hover:outline-1 hover:-outline-offset-1 hover:outline-gray-100 transition-all">
                                                <Link
                                                    to="../admin/dashboard"
                                                    className="flex w-full px-8 text-left"
                                                >
