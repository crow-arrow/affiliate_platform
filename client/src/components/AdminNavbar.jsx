                                ...
                                {navLinks.map(({ to, label, tooltip, icon }) => (
                                    <li key={to} className="flex">
                                        <NavLink 
                                            to={to}
                                            className={({ isActive }) => 
                                                `flex group pr-4 gap-2 w-full items-center text-lg rounded-lg
                                                hover:bg-white dark:hover:bg-secondary hover:text-gray-800 dark:hover:text-gray-100 
                                                transition-colors duration-300 ${isActive && 'bg-white dark:bg-secondary text-gray-800 dark:text-gray-100'}`
                                            }
                                        >
                                            {({ isActive }) => (
                                            <>
                                                <div className={`m-2 rounded-md transition-colors duration-300
