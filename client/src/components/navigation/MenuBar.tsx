...
export function MenuBar() {
  ...
  return (
    <motion.nav
      className="p-2 rounded-2xl bg-gradient-to-b from-accent/80 to-background/40 backdrop-blur-lg border border-border/40 shadow-lg relative overflow-hidden"
      initial="initial"
    >
      <motion.div
        className={`absolute -inset-2 rounded-3xl z-0 pointer-events-none ${
          isDarkTheme ? "bg-gradient-radial-dark" : "bg-gradient-radial-light"
        }`}
