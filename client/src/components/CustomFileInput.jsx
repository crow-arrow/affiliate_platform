	...
	return (
		<div className="flex gap-16 items-start">
			...
			>
				{image ? (
					<div className="relative w-full h-full">
						<img src={image} alt="Image" className="absolute top-0 left-0 w-full h-full object-contain opacity-10" />
            ...
            <div className="flex flex-col gap-6 justify-between items-center">
                ...
                {croppedImagePreview ? (
                    <img className="w-48 h-auto object-cover rounded-full" src={croppedImagePreview} alt="Preview" />
                ) : (
