...
export const ProgressBar = () => {
  ...
  const offsetSilver =
    circumferenceFullCircle -
    (circumferenceFullCircle * numberOfTravellers) / 2 / maxTravellersSilver;

  const circleSilverFirst =
    circumferenceFullCircle -
    (circumferenceFullCircle * 10) / 2 / maxTravellersSilver;
  const circleSilverSecond =
    circumferenceFullCircle -
    (circumferenceFullCircle * 14.3) / 2 / maxTravellersSilver;

  const offsetGold =
    circumferenceFullCircle -
    (circumferenceFullCircle * numberOfTravellers) / 2 / maxTravellersGold;

  const circleGoldFirst =
    circumferenceFullCircle -
    (circumferenceFullCircle * 25) / 2 / maxTravellersGold;
  const circleGoldSecond =
    circumferenceFullCircle -
    (circumferenceFullCircle * 73) / 2 / maxTravellersGold;
      ...
      {userLevel === "Gold" ? (
        <div className="flex items-end justify-arround mt-6">
          ...
          <div className="relative w-auto h-full aspect-[300/160]">
            <span className="absolute bottom-2/3 -translate-y-2/4 left-[10%] max-lg:text-sm">
              25
            </span>
            <svg
              viewBox="0 0 300 140"
            ...
            >
              ...
              <circle
                ...
                className="fill-none stroke-accent animation"
                strokeLinecap="round"
              />
              {/* <circle   
                                cx={thumbPosition.x}
            ...
            <div className="absolute left-1/2 -translate-x-1/2 bottom-0">
              <p className="text-center font-bold max-md:text-5xl text-[2vw]">
                <AnimatedNumber value={numberOfTravellers || 0} />
              </p>
              <p className="text-center text-sm max-md:text-md lg:text-sm whitespace-nowrap">
                Travellers reffered
              </p>
            </div>
          </div>
        ...
        <div className="grid w-full grid-col-1 flex-col justify-center items-start">
          <div className="flex items-end justify-arround mt-6">
            <span className="max-lg:text-sm">0</span>
            <div className="relative w-auto h-full aspect-[300/160]">
              <span className="absolute top-0 left-1/3 -translate-y-3/4 max-lg:text-sm">
                10
              </span>
              <svg
                viewBox="0 0 300 140"
              ...
              >
                ...
                <circle
                  ...
                  className="fill-none stroke-gray-400 animation"
                  strokeLinecap="round"
                />
                {/* <circle   
                                    cx={thumbPosition.x}
                                    cy={thumbPosition.y} 
                                    r="13.8"
                                    className="fill-gray-400 animate-thumb"
                                /> */}
              </svg>
              <div className="absolute left-1/2 -translate-x-1/2 bottom-0">
                <p className="text-center font-bold max-md:text-5xl text-[2vw]">
            ...
            <div className="relative w-auto h-full aspect-[300/160]">
              ...
              >
                ...
                <circle
                  ...
                  className="fill-none stroke-bronze-body animation"
                  strokeLinecap="round"
                />
                {/* <circle   
                                    cx={thumbPosition.x}
                                    cy={thumbPosition.y} 
                                    r="13.8"
                                    className="fill-bronze-body thumb-circle"
                                /> */}
              </svg>
              <div className="absolute left-1/2 -translate-x-1/2 bottom-0">
                <p className="text-center font-bold max-md:text-5xl text-[2vw]">
