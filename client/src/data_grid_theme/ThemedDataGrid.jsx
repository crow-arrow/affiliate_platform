...
import GlobalStyles from "@mui/material/GlobalStyles"; // Импортируем GlobalStyles

export const ThemedDataGrid = ({ rows, columns, getRowId, checkboxSelection, disableRowSelectionOnClick }) => {
