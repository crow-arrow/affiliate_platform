  ...
  return (
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-6">
      ...
      <input
        ...
        className="block w-full rounded-3xl bg-white px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-accent sm:text-sm"
      />
      <input
        type="text"
        placeholder="Coupon"
